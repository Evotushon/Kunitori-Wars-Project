...
public class CrashlyticsReportPersistence {
    ...
    public void deleteFinalizedReport(String str) {
        $$Lambda$CrashlyticsReportPersistence$HQEC8vhswXMGNCPEJGBQkG37DZM r0 = new FilenameFilter(str) {
        ...
        for (File delete : combineReportFiles(getFilesInDirectory(this.priorityReportsDirectory, (FilenameFilter) r0), getFilesInDirectory(this.nativeReportsDirectory, (FilenameFilter) r0), getFilesInDirectory(this.reportsDirectory, (FilenameFilter) r0))) {
            delete.delete();
        }
    }
    ...
    private List<File> capAndGetOpenSessions(@Nullable String str) {
        List<File> filesInDirectory = getFilesInDirectory(this.openSessionsDirectory, (FileFilter) new FileFilter(str) {
            private final /* synthetic */ String f$0;
    ...
    private void synthesizeReport(@NonNull File file, long j) {
        ...
        if (file2.isFile()) {
            try {
                ...
                logger4.w("Could not read user ID file in " + file.getName(), e2);
            }
        }
    ...
    private static int trimEvents(@NonNull File file, int i) {
        List<File> filesInDirectory = getFilesInDirectory(file, (FilenameFilter) $$Lambda$CrashlyticsReportPersistence$5ewmHYO883ri5BmwN_Gn2GLWEFU.INSTANCE);
        Collections.sort(filesInDirectory, $$Lambda$CrashlyticsReportPersistence$01Lorz603_5ziNugbvmzIHT6dw.INSTANCE);
