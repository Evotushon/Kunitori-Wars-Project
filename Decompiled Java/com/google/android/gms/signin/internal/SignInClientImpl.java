...
public class SignInClientImpl extends GmsClient<zae> implements zad {
    ...
    private final boolean zatb;
    private final Bundle zatc;
    ...
    private SignInClientImpl(Context context, Looper looper, boolean z, ClientSettings clientSettings, Bundle bundle, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        this.zatc = bundle;
        this.zaos = clientSettings.getClientSessionId();
    }
    ...
    public final void zaa(IAccountAccessor iAccountAccessor, boolean z) {
        try {
            ((zae) getService()).zaa(iAccountAccessor, this.zaos.intValue(), z);
    ...
    public final void zacu() {
        try {
            ((zae) getService()).zam(this.zaos.intValue());
        } catch (RemoteException unused) {
    ...
    public final void zaa(zac zac) {
        ...
        try {
            Account accountOrDefault = this.zaex.getAccountOrDefault();
            ...
            ((zae) getService()).zaa(new zak(new ResolveAccountRequest(accountOrDefault, this.zaos.intValue(), googleSignInAccount)), zac);
    ...
    public Bundle getGetServiceRequestExtraArgs() {
        if (!getContext().getPackageName().equals(this.zaex.getRealClientPackageName())) {
            this.zatc.putString("com.google.android.gms.signin.internal.realClientPackageName", this.zaex.getRealClientPackageName());
        }
        return this.zatc;
    }
