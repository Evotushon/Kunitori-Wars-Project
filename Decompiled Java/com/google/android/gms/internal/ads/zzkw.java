...
public final class zzkw {
    ...
    public static zzkw zzbe(String str) {
        return new zzkw(str, (String) null, (MediaCodecInfo.CodecCapabilities) null, false, false);
    }

    public static zzkw zza(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2) {
        return new zzkw(str, str2, codecCapabilities, z, z2);
    }

    /* JADX WARNING: Code restructure failed: missing block: B:32:0x005a, code lost:
        if ((com.google.android.gms.internal.ads.zzop.SDK_INT >= 21 && r4.isFeatureSupported("secure-playback")) != false) goto L_0x005e;
     */
    /* JADX WARNING: Removed duplicated region for block: B:14:0x0031  */
    /* JADX WARNING: Removed duplicated region for block: B:25:0x0049  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private zzkw(java.lang.String r2, java.lang.String r3, android.media.MediaCodecInfo.CodecCapabilities r4, boolean r5, boolean r6) {
        /*
            r1 = this;
            r1.<init>()
            java.lang.Object r2 = com.google.android.gms.internal.ads.zzob.checkNotNull(r2)
            ...
            int r5 = com.google.android.gms.internal.ads.zzop.SDK_INT
            r0 = 19
        ...
        L_0x0045:
            ...
            int r6 = com.google.android.gms.internal.ads.zzop.SDK_INT
        ...
        L_0x005e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzkw.<init>(java.lang.String, java.lang.String, android.media.MediaCodecInfo$CodecCapabilities, boolean, boolean):void");
    }

    public final MediaCodecInfo.CodecProfileLevel[] zzhf() {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.zzazj;
        if (codecCapabilities == null || codecCapabilities.profileLevels == null) {
            return new MediaCodecInfo.CodecProfileLevel[0];
        }
        return this.zzazj.profileLevels;
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean zzbf(java.lang.String r12) {
        /*
            r11 = this;
            r0 = 1
        ...
        L_0x00c7:
            ...
            return r4
        L_0x0100:
            android.util.Pair r2 = com.google.android.gms.internal.ads.zzkz.zzbh(r12)
            if (r2 != 0) goto L_0x0107
            return r0
        L_0x0107:
            android.media.MediaCodecInfo$CodecProfileLevel[] r5 = r11.zzhf()
            int r6 = r5.length
            r7 = 0
        L_0x010d:
        ...
        L_0x015b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzkw.zzbf(java.lang.String):boolean");
    }
    ...
    public final boolean zza(int i, int i2, double d) {
        ...
        if (codecCapabilities == null) {
            zzbg("sizeAndRate.caps");
            return false;
        }
        MediaCodecInfo.VideoCapabilities videoCapabilities = codecCapabilities.getVideoCapabilities();
        if (videoCapabilities == null) {
            zzbg("sizeAndRate.vCaps");
            return false;
    ...
    public final Point zzd(int i, int i2) {
        ...
        return new Point(zzop.zzf(i, widthAlignment) * widthAlignment, zzop.zzf(i2, heightAlignment) * heightAlignment);
    }
    ...
    public final boolean zzaq(int i) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.zzazj;
        if (codecCapabilities == null) {
            zzbg("sampleRate.caps");
            return false;
        }
        MediaCodecInfo.AudioCapabilities audioCapabilities = codecCapabilities.getAudioCapabilities();
        if (audioCapabilities == null) {
            zzbg("sampleRate.aCaps");
            return false;
    ...
    public final boolean zzar(int i) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.zzazj;
        if (codecCapabilities == null) {
            zzbg("channelCount.caps");
            return false;
        }
        MediaCodecInfo.AudioCapabilities audioCapabilities = codecCapabilities.getAudioCapabilities();
        if (audioCapabilities == null) {
            zzbg("channelCount.aCaps");
            return false;
