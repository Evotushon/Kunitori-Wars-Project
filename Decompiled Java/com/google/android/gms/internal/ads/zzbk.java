...
public final class zzbk extends zzedu {
    ...
    private zzeee zzcz = zzeee.zzigb;
    private long zzda;
    private int zzdb;
    private int zzdc;
    private int zzdd;
    ...
    public final void zzg(ByteBuffer byteBuffer) {
        zzo(byteBuffer);
        if (getVersion() == 1) {
            this.zzct = zzedx.zzfw(zzbg.zzc(byteBuffer));
            this.zzcu = zzedx.zzfw(zzbg.zzc(byteBuffer));
            this.zzcv = zzbg.zza(byteBuffer);
            this.zzcw = zzbg.zzc(byteBuffer);
        } else {
            this.zzct = zzedx.zzfw(zzbg.zza(byteBuffer));
            this.zzcu = zzedx.zzfw(zzbg.zza(byteBuffer));
            this.zzcv = zzbg.zza(byteBuffer);
