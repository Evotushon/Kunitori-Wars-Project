...
public final class zzut {
    ...
    private static AdSize[] zzcd(String str) {
        int i;
        int i2;
    ...
    public zzut(Context context, AttributeSet attributeSet) {
        ...
        if (z && !z2) {
            this.zzcdt = zzcd(string);
        } else if (!z && z2) {
            this.zzcdt = zzcd(string2);
        } else if (z) {
            throw new IllegalArgumentException("Either XML attribute \"adSize\" or XML attribute \"supportedAdSizes\" should be specified, but not both.");
        } else {
            throw new IllegalArgumentException("Required XML attribute \"adSize\" was missing.");
        }
        this.zzbri = obtainAttributes.getString(R.styleable.AdsAttrs_adUnitId);
