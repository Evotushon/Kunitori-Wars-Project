...
public abstract class zzbc implements zzbe {
    ...
    public final zzbf zza(zzedv zzedv, zzbi zzbi) throws IOException {
        int read;
        long j;
        zzedv zzedv2 = zzedv;
        zzbi zzbi2 = zzbi;
        ...
        do {
            read = zzedv2.read(this.zzcq.get());
            if (read == 8) {
                ...
                if (zza >= 8 || zza <= 1) {
                    ...
                    if (zza == 1) {
                        ...
                        zzedv2.read(this.zzcq.get());
                        this.zzcq.get().position(8);
                        j = zzbg.zzc(this.zzcq.get()) - 16;
                    } else {
                        j = zza == 0 ? zzedv.size() - zzedv.position() : zza - 8;
                    }
                    if ("uuid".equals(zzf)) {
                    ...
                    zza2.zza(zzbi2);
                    this.zzcq.get().rewind();
                    zza2.zza(zzedv, this.zzcq.get(), j2, this);
                    return zza2;
                }
                Logger logger = zzcp;
