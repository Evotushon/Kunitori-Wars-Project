...
final class zzzp extends zzzi<String> {
    zzzp(int i, String str, String str2) {
        super(i, str, str2, (zzzl) null);
    }
    ...
    public final /* synthetic */ Object zzb(JSONObject jSONObject) {
        return jSONObject.optString(getKey(), (String) zzqi());
    }

    public final /* synthetic */ Object zza(SharedPreferences sharedPreferences) {
        return sharedPreferences.getString(getKey(), (String) zzqi());
    }
}
