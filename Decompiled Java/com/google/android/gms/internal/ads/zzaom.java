...
public final class zzaom extends zzaow {
    private static final Set<String> zzdgj = CollectionUtils.setOf("top-left", "top-right", "top-center", "center", "bottom-left", "bottom-right", "bottom-center");
    ...
    private String zzdgk = "top-right";
    private boolean zzdgl = true;
    private int zzdgm = 0;
    private int zzdgn = 0;
    private int zzdgo = 0;
    private int zzdgp = 0;
    ...
    public zzaom(zzbdv zzbdv, zzaoz zzaoz) {
        super(zzbdv, "resize");
        this.zzdae = zzbdv;
        this.zzdfz = zzbdv.zzys();
        this.zzcyr = zzaoz;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:106:0x01eb, code lost:
        r5 = ((r1.zzdgm + r1.zzdgo) + (r1.width / 2)) - 25;
        r8 = ((r1.zzdgn + r1.zzdgp) + (r1.height / 2)) - 25;
     */
    ...
    public final void zzg(java.util.Map<java.lang.String, java.lang.String> r17) {
        /*
            ...
            monitor-enter(r2)
            android.app.Activity r3 = r1.zzdfz     // Catch:{ all -> 0x04c3 }
            if (r3 != 0) goto L_0x0012
            java.lang.String r0 = "Not an activity context. Cannot resize."
            r1.zzdt(r0)     // Catch:{ all -> 0x04c3 }
            monitor-exit(r2)     // Catch:{ all -> 0x04c3 }
            return
        L_0x0012:
            com.google.android.gms.internal.ads.zzbdv r3 = r1.zzdae     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzbfl r3 = r3.zzaad()     // Catch:{ all -> 0x04c3 }
        ...
        L_0x0021:
            com.google.android.gms.internal.ads.zzbdv r3 = r1.zzdae     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzbfl r3 = r3.zzaad()     // Catch:{ all -> 0x04c3 }
            boolean r3 = r3.zzaby()     // Catch:{ all -> 0x04c3 }
        ...
        L_0x0034:
            com.google.android.gms.internal.ads.zzbdv r3 = r1.zzdae     // Catch:{ all -> 0x04c3 }
            boolean r3 = r3.zzaak()     // Catch:{ all -> 0x04c3 }
        ...
        L_0x0043:
            ...
            com.google.android.gms.ads.internal.zzq.zzkv()     // Catch:{ all -> 0x04c3 }
            java.lang.String r3 = "width"
            java.lang.Object r3 = r0.get(r3)     // Catch:{ all -> 0x04c3 }
            java.lang.String r3 = (java.lang.String) r3     // Catch:{ all -> 0x04c3 }
            int r3 = com.google.android.gms.internal.ads.zzawo.zzej(r3)     // Catch:{ all -> 0x04c3 }
        ...
        L_0x00f8:
            ...
            return
        L_0x0101:
            android.app.Activity r0 = r1.zzdfz     // Catch:{ all -> 0x04c3 }
            ...
            goto L_0x04bc
        L_0x0111:
            com.google.android.gms.internal.ads.zzawo r5 = com.google.android.gms.ads.internal.zzq.zzkv()     // Catch:{ all -> 0x04c3 }
            android.app.Activity r6 = r1.zzdfz     // Catch:{ all -> 0x04c3 }
            int[] r5 = r5.zze(r6)     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzawo r6 = com.google.android.gms.ads.internal.zzq.zzkv()     // Catch:{ all -> 0x04c3 }
            android.app.Activity r7 = r1.zzdfz     // Catch:{ all -> 0x04c3 }
        ...
        L_0x0144:
            ...
            com.google.android.gms.internal.ads.zzawf.zzfa(r5)     // Catch:{ all -> 0x04c3 }
            goto L_0x0238
        L_0x0153:
            boolean r5 = r1.zzdgl     // Catch:{ all -> 0x04c3 }
            if (r5 == 0) goto L_0x022b
            java.lang.String r5 = r1.zzdgk     // Catch:{ all -> 0x04c3 }
        ...
        L_0x019e:
            ...
            int r5 = r1.zzdgm     // Catch:{ all -> 0x04c3 }
            int r8 = r1.zzdgo     // Catch:{ all -> 0x04c3 }
            int r5 = r5 + r8
            int r8 = r1.width     // Catch:{ all -> 0x04c3 }
            int r5 = r5 + r8
            int r5 = r5 - r14
            int r8 = r1.zzdgn     // Catch:{ all -> 0x04c3 }
            int r15 = r1.zzdgp     // Catch:{ all -> 0x04c3 }
            goto L_0x021b
        L_0x01b8:
            int r5 = r1.zzdgm     // Catch:{ all -> 0x04c3 }
            int r8 = r1.zzdgo     // Catch:{ all -> 0x04c3 }
        ...
        L_0x023d:
            ...
            int r6 = r1.zzdgm     // Catch:{ all -> 0x04c3 }
            int r7 = r1.zzdgo     // Catch:{ all -> 0x04c3 }
            int r6 = r6 + r7
            r5[r4] = r6     // Catch:{ all -> 0x04c3 }
            int r6 = r1.zzdgn     // Catch:{ all -> 0x04c3 }
            int r7 = r1.zzdgp     // Catch:{ all -> 0x04c3 }
            int r6 = r6 + r7
        ...
        L_0x0252:
            ...
            int r7 = r1.zzdgm     // Catch:{ all -> 0x04c3 }
            int r8 = r1.zzdgo     // Catch:{ all -> 0x04c3 }
            int r7 = r7 + r8
            int r8 = r1.zzdgn     // Catch:{ all -> 0x04c3 }
            int r15 = r1.zzdgp     // Catch:{ all -> 0x04c3 }
        ...
        L_0x029b:
            ...
            return
        L_0x02a4:
            com.google.android.gms.internal.ads.zzvh.zzoz()     // Catch:{ all -> 0x04c3 }
            android.app.Activity r6 = r1.zzdfz     // Catch:{ all -> 0x04c3 }
            int r7 = r1.width     // Catch:{ all -> 0x04c3 }
            int r6 = com.google.android.gms.internal.ads.zzayx.zzb((android.content.Context) r6, (int) r7)     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzvh.zzoz()     // Catch:{ all -> 0x04c3 }
            android.app.Activity r7 = r1.zzdfz     // Catch:{ all -> 0x04c3 }
            int r8 = r1.height     // Catch:{ all -> 0x04c3 }
            int r7 = com.google.android.gms.internal.ads.zzayx.zzb((android.content.Context) r7, (int) r8)     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzbdv r8 = r1.zzdae     // Catch:{ all -> 0x04c3 }
            ...
            com.google.android.gms.internal.ads.zzbdv r9 = r1.zzdae     // Catch:{ all -> 0x04c3 }
            android.view.View r9 = r9.getView()     // Catch:{ all -> 0x04c3 }
            r15.removeView(r9)     // Catch:{ all -> 0x04c3 }
            android.widget.PopupWindow r9 = r1.zzdgt     // Catch:{ all -> 0x04c3 }
            if (r9 != 0) goto L_0x0309
            android.view.ViewGroup r8 = (android.view.ViewGroup) r8     // Catch:{ all -> 0x04c3 }
            r1.zzdgv = r8     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.ads.internal.zzq.zzkv()     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzbdv r8 = r1.zzdae     // Catch:{ all -> 0x04c3 }
            android.view.View r8 = r8.getView()     // Catch:{ all -> 0x04c3 }
            android.graphics.Bitmap r8 = com.google.android.gms.internal.ads.zzawo.zzk(r8)     // Catch:{ all -> 0x04c3 }
            android.widget.ImageView r9 = new android.widget.ImageView     // Catch:{ all -> 0x04c3 }
            android.app.Activity r15 = r1.zzdfz     // Catch:{ all -> 0x04c3 }
            r9.<init>(r15)     // Catch:{ all -> 0x04c3 }
            r1.zzdgr = r9     // Catch:{ all -> 0x04c3 }
            android.widget.ImageView r9 = r1.zzdgr     // Catch:{ all -> 0x04c3 }
            r9.setImageBitmap(r8)     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzbdv r8 = r1.zzdae     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzbfl r8 = r8.zzaad()     // Catch:{ all -> 0x04c3 }
            r1.zzdgq = r8     // Catch:{ all -> 0x04c3 }
            android.view.ViewGroup r8 = r1.zzdgv     // Catch:{ all -> 0x04c3 }
            android.widget.ImageView r9 = r1.zzdgr     // Catch:{ all -> 0x04c3 }
            r8.addView(r9)     // Catch:{ all -> 0x04c3 }
            goto L_0x030e
        L_0x0309:
            android.widget.PopupWindow r8 = r1.zzdgt     // Catch:{ all -> 0x04c3 }
            r8.dismiss()     // Catch:{ all -> 0x04c3 }
        L_0x030e:
            android.widget.RelativeLayout r8 = new android.widget.RelativeLayout     // Catch:{ all -> 0x04c3 }
            android.app.Activity r9 = r1.zzdfz     // Catch:{ all -> 0x04c3 }
            r8.<init>(r9)     // Catch:{ all -> 0x04c3 }
            r1.zzdgu = r8     // Catch:{ all -> 0x04c3 }
            android.widget.RelativeLayout r8 = r1.zzdgu     // Catch:{ all -> 0x04c3 }
            ...
            com.google.android.gms.ads.internal.zzq.zzkv()     // Catch:{ all -> 0x04c3 }
            android.widget.RelativeLayout r8 = r1.zzdgu     // Catch:{ all -> 0x04c3 }
            android.widget.PopupWindow r8 = com.google.android.gms.internal.ads.zzawo.zza((android.view.View) r8, (int) r6, (int) r7, (boolean) r4)     // Catch:{ all -> 0x04c3 }
            r1.zzdgt = r8     // Catch:{ all -> 0x04c3 }
            android.widget.PopupWindow r8 = r1.zzdgt     // Catch:{ all -> 0x04c3 }
            r8.setOutsideTouchable(r3)     // Catch:{ all -> 0x04c3 }
            android.widget.PopupWindow r8 = r1.zzdgt     // Catch:{ all -> 0x04c3 }
            r8.setTouchable(r3)     // Catch:{ all -> 0x04c3 }
            android.widget.PopupWindow r8 = r1.zzdgt     // Catch:{ all -> 0x04c3 }
            boolean r9 = r1.zzdgl     // Catch:{ all -> 0x04c3 }
        ...
        L_0x0344:
            ...
            android.app.Activity r9 = r1.zzdfz     // Catch:{ all -> 0x04c3 }
            r8.<init>(r9)     // Catch:{ all -> 0x04c3 }
            r1.zzdgs = r8     // Catch:{ all -> 0x04c3 }
            android.widget.RelativeLayout$LayoutParams r8 = new android.widget.RelativeLayout$LayoutParams     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzvh.zzoz()     // Catch:{ all -> 0x04c3 }
            android.app.Activity r9 = r1.zzdfz     // Catch:{ all -> 0x04c3 }
            int r9 = com.google.android.gms.internal.ads.zzayx.zzb((android.content.Context) r9, (int) r14)     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzvh.zzoz()     // Catch:{ all -> 0x04c3 }
            android.app.Activity r15 = r1.zzdfz     // Catch:{ all -> 0x04c3 }
            int r14 = com.google.android.gms.internal.ads.zzayx.zzb((android.content.Context) r15, (int) r14)     // Catch:{ all -> 0x04c3 }
            r8.<init>(r9, r14)     // Catch:{ all -> 0x04c3 }
            java.lang.String r9 = r1.zzdgk     // Catch:{ all -> 0x04c3 }
        ...
        L_0x03f7:
            ...
            r8.addRule(r9)     // Catch:{ all -> 0x04c3 }
        L_0x03fd:
            android.widget.LinearLayout r9 = r1.zzdgs     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzaop r10 = new com.google.android.gms.internal.ads.zzaop     // Catch:{ all -> 0x04c3 }
            ...
            android.widget.RelativeLayout r9 = r1.zzdgu     // Catch:{ all -> 0x04c3 }
            android.widget.LinearLayout r10 = r1.zzdgs     // Catch:{ all -> 0x04c3 }
            r9.addView(r10, r8)     // Catch:{ all -> 0x04c3 }
            android.widget.PopupWindow r8 = r1.zzdgt     // Catch:{ RuntimeException -> 0x046d }
            android.view.View r0 = r0.getDecorView()     // Catch:{ RuntimeException -> 0x046d }
            com.google.android.gms.internal.ads.zzvh.zzoz()     // Catch:{ RuntimeException -> 0x046d }
            android.app.Activity r9 = r1.zzdfz     // Catch:{ RuntimeException -> 0x046d }
            r10 = r5[r4]     // Catch:{ RuntimeException -> 0x046d }
            int r9 = com.google.android.gms.internal.ads.zzayx.zzb((android.content.Context) r9, (int) r10)     // Catch:{ RuntimeException -> 0x046d }
            com.google.android.gms.internal.ads.zzvh.zzoz()     // Catch:{ RuntimeException -> 0x046d }
            android.app.Activity r10 = r1.zzdfz     // Catch:{ RuntimeException -> 0x046d }
            r11 = r5[r3]     // Catch:{ RuntimeException -> 0x046d }
            int r10 = com.google.android.gms.internal.ads.zzayx.zzb((android.content.Context) r10, (int) r11)     // Catch:{ RuntimeException -> 0x046d }
            r8.showAtLocation(r0, r4, r9, r10)     // Catch:{ RuntimeException -> 0x046d }
            r0 = r5[r4]     // Catch:{ all -> 0x04c3 }
            r8 = r5[r3]     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzaoz r9 = r1.zzcyr     // Catch:{ all -> 0x04c3 }
            if (r9 == 0) goto L_0x0445
            com.google.android.gms.internal.ads.zzaoz r9 = r1.zzcyr     // Catch:{ all -> 0x04c3 }
            int r10 = r1.width     // Catch:{ all -> 0x04c3 }
            int r11 = r1.height     // Catch:{ all -> 0x04c3 }
            r9.zzc(r0, r8, r10, r11)     // Catch:{ all -> 0x04c3 }
        L_0x0445:
            com.google.android.gms.internal.ads.zzbdv r0 = r1.zzdae     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzbfl r6 = com.google.android.gms.internal.ads.zzbfl.zzq(r6, r7)     // Catch:{ all -> 0x04c3 }
            r0.zza((com.google.android.gms.internal.ads.zzbfl) r6)     // Catch:{ all -> 0x04c3 }
            r0 = r5[r4]     // Catch:{ all -> 0x04c3 }
            ...
            r1.zza(r0, r3, r4, r5)     // Catch:{ all -> 0x04c3 }
            java.lang.String r0 = "resized"
            r1.zzdv(r0)     // Catch:{ all -> 0x04c3 }
            monitor-exit(r2)     // Catch:{ all -> 0x04c3 }
            return
        L_0x046d:
            r0 = move-exception
        ...
        L_0x0488:
            r1.zzdt(r0)     // Catch:{ all -> 0x04c3 }
            android.widget.RelativeLayout r0 = r1.zzdgu     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzbdv r3 = r1.zzdae     // Catch:{ all -> 0x04c3 }
            android.view.View r3 = r3.getView()     // Catch:{ all -> 0x04c3 }
            r0.removeView(r3)     // Catch:{ all -> 0x04c3 }
            android.view.ViewGroup r0 = r1.zzdgv     // Catch:{ all -> 0x04c3 }
            if (r0 == 0) goto L_0x04b3
            android.view.ViewGroup r0 = r1.zzdgv     // Catch:{ all -> 0x04c3 }
            android.widget.ImageView r3 = r1.zzdgr     // Catch:{ all -> 0x04c3 }
            r0.removeView(r3)     // Catch:{ all -> 0x04c3 }
            android.view.ViewGroup r0 = r1.zzdgv     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzbdv r3 = r1.zzdae     // Catch:{ all -> 0x04c3 }
            android.view.View r3 = r3.getView()     // Catch:{ all -> 0x04c3 }
            ...
            com.google.android.gms.internal.ads.zzbdv r0 = r1.zzdae     // Catch:{ all -> 0x04c3 }
            com.google.android.gms.internal.ads.zzbfl r3 = r1.zzdgq     // Catch:{ all -> 0x04c3 }
            r0.zza((com.google.android.gms.internal.ads.zzbfl) r3)     // Catch:{ all -> 0x04c3 }
        L_0x04b3:
            monitor-exit(r2)     // Catch:{ all -> 0x04c3 }
            return
        L_0x04b5:
        ...
        L_0x04c3:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaom.zzg(java.util.Map):void");
    }
