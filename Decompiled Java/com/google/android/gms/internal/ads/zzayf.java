...
public final class zzayf {
    private static final zzayh<Map<String, ?>> zzdvt = new zzayi();
    ...
    public static String zza(zzayk zzayk) {
        return zzk(zzayk);
    }
    ...
    private static String zzk(Object obj) {
        ...
        try {
            ...
            zzawf.zzc("Error when writing JSON.", e);
            return null;
        }
    }
    ...
    private static void zza(JsonWriter jsonWriter, Object obj) throws IOException {
        if (obj == null) {
            ...
            jsonWriter.value((String) obj);
        } else if (obj instanceof zzayk) {
            ((zzayk) obj).zza(jsonWriter);
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (!(jSONArray == null || jSONArray.length() == 0)) {
                        ...
                        if (obj == null) {
                            ...
                            zzawf.zzfa(valueOf.length() != 0 ? "Expected JSONArray with at least 1 non-null element for key:".concat(valueOf) : new String("Expected JSONArray with at least 1 non-null element for key:"));
                        } else if (obj instanceof JSONObject) {
                            ...
                            zzawf.zzfa(String.format("JSONArray with unsupported type %s for key:%s", new Object[]{obj.getClass().getCanonicalName(), next}));
                        }
                    }
                    ...
                    zzawf.zzfa(valueOf2.length() != 0 ? "Unsupported type for key:".concat(valueOf2) : new String("Unsupported type for key:"));
                }
            }
        }
        return bundle;
