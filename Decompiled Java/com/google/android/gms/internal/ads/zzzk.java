...
final class zzzk extends zzzi<Integer> {
    zzzk(int i, String str, Integer num) {
        super(1, str, num, (zzzl) null);
    }
    ...
    public final /* synthetic */ Object zzb(JSONObject jSONObject) {
        return Integer.valueOf(jSONObject.optInt(getKey(), ((Integer) zzqi()).intValue()));
    }

    public final /* synthetic */ Object zza(SharedPreferences sharedPreferences) {
        return Integer.valueOf(sharedPreferences.getInt(getKey(), ((Integer) zzqi()).intValue()));
    }
}
