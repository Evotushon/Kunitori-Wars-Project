...
interface zzecs {
    ...
    void zza(int i, zzdxn zzdxn) throws IOException;

    <K, V> void zza(int i, zzeac<K, V> zzeac, Map<K, V> map) throws IOException;

    void zza(int i, Object obj, zzebd zzebd) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzebd zzebd) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzebd zzebd) throws IOException;

    void zzb(int i, List<zzdxn> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzebd zzebd) throws IOException;
    ...
    @Deprecated
    void zzgi(int i) throws IOException;

    @Deprecated
    void zzgj(int i) throws IOException;
