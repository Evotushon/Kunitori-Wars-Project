...
public final class zzkz {
    private static final zzkw zzazo = zzkw.zzbe("OMX.google.raw.decoder");
    private static final Pattern zzazp = Pattern.compile("^\\D?(\\d+)$");
    private static final HashMap<zza, List<zzkw>> zzazq = new HashMap<>();
    private static final SparseIntArray zzazr;
    private static final SparseIntArray zzazs;
    private static final Map<String, Integer> zzazt;
    private static int zzazu = -1;

    public static zzkw zzhg() {
        return zzazo;
    }

    public static zzkw zzb(String str, boolean z) throws zzld {
        List<zzkw> zzc = zzc(str, z);
        if (zzc.isEmpty()) {
            return null;
        }
        return zzc.get(0);
    ...
    static final class zza {
        ...
        public final boolean equals(Object obj) {
            ...
            if (obj != null && obj.getClass() == zza.class) {
                zza zza = (zza) obj;
                return TextUtils.equals(this.mimeType, zza.mimeType) && this.zzazi == zza.zzazi;
            }
        }
    }

    private static synchronized List<zzkw> zzc(String str, boolean z) throws zzld {
        synchronized (zzkz.class) {
            zza zza2 = new zza(str, z);
            List<zzkw> list = zzazq.get(zza2);
            if (list != null) {
                return list;
            }
            List<zzkw> zza3 = zza(zza2, zzop.SDK_INT >= 21 ? new zzle(z) : new zzlf());
            if (z && zza3.isEmpty() && 21 <= zzop.SDK_INT && zzop.SDK_INT <= 23) {
                zza3 = zza(zza2, (zzlc) new zzlf());
                if (!zza3.isEmpty()) {
            ...
            List<zzkw> unmodifiableList = Collections.unmodifiableList(zza3);
            zzazq.put(zza2, unmodifiableList);
    ...
    public static int zzhh() throws zzld {
        ...
        if (zzazu == -1) {
            int i2 = 0;
            zzkw zzb = zzb("video/avc", false);
            if (zzb != null) {
                MediaCodecInfo.CodecProfileLevel[] zzhf = zzb.zzhf();
                int length = zzhf.length;
                int i3 = 0;
                while (i2 < length) {
                    int i4 = zzhf[i2].level;
                    if (i4 != 1 && i4 != 2) {
                        switch (i4) {
                            case 8:
                            case 16:
                ...
                i2 = Math.max(i3, zzop.SDK_INT >= 21 ? 345600 : 172800);
            }
            zzazu = i2;
        }
        return zzazu;
    ...
    public static android.util.Pair<java.lang.Integer, java.lang.Integer> zzbh(java.lang.String r9) {
        /*
            r0 = 0
        ...
        L_0x006b:
            ...
            return r0
        L_0x006f:
            java.util.regex.Pattern r2 = zzazp
            r3 = r1[r8]
        ...
        L_0x00ab:
            java.util.Map<java.lang.String, java.lang.Integer> r9 = zzazt
            r1 = r1[r6]
        ...
        L_0x00f6:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzkz.zzbh(java.lang.String):android.util.Pair");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.util.List<com.google.android.gms.internal.ads.zzkw> zza(com.google.android.gms.internal.ads.zzkz.zza r17, com.google.android.gms.internal.ads.zzlc r18) throws com.google.android.gms.internal.ads.zzld {
        /*
            r1 = r17
            r2 = r18
            ...
            boolean r6 = r18.zzhi()     // Catch:{ Exception -> 0x02ae }
            r8 = 0
        L_0x0014:
            ...
            goto L_0x01af
        L_0x0030:
            int r0 = com.google.android.gms.internal.ads.zzop.SDK_INT     // Catch:{ Exception -> 0x02ae }
            r13 = 21
        ...
        L_0x0078:
            ...
            java.lang.String r13 = com.google.android.gms.internal.ads.zzop.DEVICE     // Catch:{ Exception -> 0x02ae }
        ...
        L_0x0090:
            ...
            java.lang.String r14 = com.google.android.gms.internal.ads.zzop.DEVICE     // Catch:{ Exception -> 0x02ae }
            ...
            boolean r0 = r0.equals(r14)     // Catch:{ Exception -> 0x02ae }
            if (r0 != 0) goto L_0x01af
            java.lang.String r0 = com.google.android.gms.internal.ads.zzop.DEVICE     // Catch:{ Exception -> 0x02ae }
        ...
        L_0x014d:
            ...
            java.lang.String r15 = com.google.android.gms.internal.ads.zzop.MANUFACTURER     // Catch:{ Exception -> 0x02ae }
        ...
        L_0x01b8:
            ...
            int r2 = com.google.android.gms.internal.ads.zzop.SDK_INT     // Catch:{ Exception -> 0x022e }
            r16 = r5
            r5 = 22
            if (r2 > r5) goto L_0x01fa
            java.lang.String r2 = com.google.android.gms.internal.ads.zzop.MODEL     // Catch:{ Exception -> 0x01f8 }
        ...
        L_0x01fb:
            ...
            boolean r5 = r1.zzazi     // Catch:{ Exception -> 0x01f8 }
        ...
        L_0x0204:
            ...
            goto L_0x0202
        L_0x020b:
            com.google.android.gms.internal.ads.zzkw r0 = com.google.android.gms.internal.ads.zzkw.zza(r10, r4, r0, r2, r5)     // Catch:{ Exception -> 0x01f8 }
        ...
        L_0x0214:
            ...
            r5 = 1
            com.google.android.gms.internal.ads.zzkw r0 = com.google.android.gms.internal.ads.zzkw.zza(r7, r4, r0, r2, r5)     // Catch:{ Exception -> 0x022a }
        ...
        L_0x0231:
            r5 = 1
        L_0x0232:
            int r2 = com.google.android.gms.internal.ads.zzop.SDK_INT     // Catch:{ Exception -> 0x02ae }
            r7 = 23
            java.lang.String r5 = "MediaCodecUtil"
        ...
        L_0x02b7:
            goto L_0x02b6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzkz.zza(com.google.android.gms.internal.ads.zzkz$zza, com.google.android.gms.internal.ads.zzlc):java.util.List");
    }
    ...
    private static Pair<Integer, Integer> zza(String str, String[] strArr) {
        ...
        try {
            ...
            Integer valueOf4 = Integer.valueOf(zzazr.get(num2.intValue()));
            if (valueOf4 == null) {
            ...
            Integer valueOf6 = Integer.valueOf(zzazs.get(num.intValue()));
            if (valueOf6 != null) {
    ...
    static {
        ...
        zzazr = sparseIntArray;
        sparseIntArray.put(66, 1);
        zzazr.put(77, 2);
        zzazr.put(88, 4);
        zzazr.put(100, 8);
        SparseIntArray sparseIntArray2 = new SparseIntArray();
        zzazs = sparseIntArray2;
        ...
        zzazt.put("L120", 1024);
        zzazt.put("L123", 4096);
        zzazt.put("L150", 16384);
        zzazt.put("L153", 65536);
        zzazt.put("L156", 262144);
        zzazt.put("L180", 1048576);
        zzazt.put("L183", 4194304);
        zzazt.put("L186", 16777216);
        zzazt.put("H30", 2);
        zzazt.put("H60", 8);
        zzazt.put("H63", 32);
        zzazt.put("H90", 128);
        ...
        zzazt.put("H120", 2048);
        zzazt.put("H123", 8192);
        zzazt.put("H150", 32768);
        zzazt.put("H153", 131072);
        zzazt.put("H156", 524288);
        zzazt.put("H180", 2097152);
        zzazt.put("H183", 8388608);
        zzazt.put("H186", 33554432);
    }
}
