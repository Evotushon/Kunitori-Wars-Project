...
public final class zzcfb {
    public static String zza(JSONObject jSONObject, String str, String str2) {
        ...
        if (!((Boolean) zzvh.zzpd().zzd(zzzx.zzcli)).booleanValue() || jSONObject == null || (optJSONArray = jSONObject.optJSONArray(str2)) == null) {
            return "";
        }
        ...
        if (!(jSONArray == null || str == null)) {
            ...
            while (i < jSONArray.length()) {
                try {
                    ...
                    zzq.zzkz().zza(e, "RtbAdapterMap.hasAtleastOneRegexMatch");
                }
            }
        }
        return false;
