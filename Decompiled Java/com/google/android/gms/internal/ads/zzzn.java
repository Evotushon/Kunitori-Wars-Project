...
final class zzzn extends zzzi<Long> {
    zzzn(int i, String str, Long l) {
        super(1, str, l, (zzzl) null);
    }
    ...
    public final /* synthetic */ Object zzb(JSONObject jSONObject) {
        return Long.valueOf(jSONObject.optLong(getKey(), ((Long) zzqi()).longValue()));
    }

    public final /* synthetic */ Object zza(SharedPreferences sharedPreferences) {
        return Long.valueOf(sharedPreferences.getLong(getKey(), ((Long) zzqi()).longValue()));
    }
}
