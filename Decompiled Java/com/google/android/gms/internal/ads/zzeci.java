...
final class zzeci extends zzecf {
    zzeci() {
    }
    ...
    public final int zzb(int r12, byte[] r13, int r14, int r15) {
        ...
        L_0x001f:
            ...
            int r12 = com.google.android.gms.internal.ads.zzece.zzaq(r8, r14)
            return r12
        L_0x0032:
            r10 = r14
            r14 = r12
        ...
        L_0x0046:
            ...
            int r12 = com.google.android.gms.internal.ads.zzece.zzaq(r8, r9)
            return r12
        L_0x0057:
            r14 = r12
            r12 = 0
        ...
        L_0x005d:
            ...
            int r12 = com.google.android.gms.internal.ads.zzece.zzj(r8, r9, r14)
            return r12
        L_0x006a:
            r10 = r14
            r14 = r12
        ...
        L_0x00a5:
            ...
            int r12 = com.google.android.gms.internal.ads.zzece.zzn(r13, r14, r15)
            return r12
        L_0x00b0:
            int r8 = r14 + 1
            byte r14 = r13[r14]
        ...
        L_0x00ea:
            ...
            goto L_0x008e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzeci.zzb(int, byte[], int, int):int");
    }
            ...
            while (r13 < i3) {
                ...
                if (zzecg.zze(b2)) {
                    ...
                    while (i6 < i3) {
                        ...
                        i6++;
                        zzecg.zza(b3, cArr, i7);
                        i7++;
                    }
                    r13 = i6;
                    i5 = i7;
                } else if (zzecg.zzf(b2)) {
                    if (i6 < i3) {
                        zzecg.zza(b2, bArr[i6], cArr, i5);
                        r13 = i6 + 1;
                        i5++;
                    } else {
                        throw zzdzh.zzbdq();
                    }
                } else if (zzecg.zzg(b2)) {
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        zzecg.zza(b2, bArr[i6], bArr[i8], cArr, i5);
                        r13 = i8 + 1;
                        i5++;
                    } else {
                        throw zzdzh.zzbdq();
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    zzecg.zza(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    r13 = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzdzh.zzbdq();
