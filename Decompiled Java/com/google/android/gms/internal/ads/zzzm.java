...
final class zzzm extends zzzi<Float> {
    zzzm(int i, String str, Float f) {
        super(1, str, f, (zzzl) null);
    }
    ...
    public final /* synthetic */ Object zzb(JSONObject jSONObject) {
        return Float.valueOf((float) jSONObject.optDouble(getKey(), (double) ((Float) zzqi()).floatValue()));
    }

    public final /* synthetic */ Object zza(SharedPreferences sharedPreferences) {
        return Float.valueOf(sharedPreferences.getFloat(getKey(), ((Float) zzqi()).floatValue()));
    }
}
