...
public final class zzbki implements zzeej<Set<zzbuv<zzpt>>> {
    ...
    private zzbki(zzeew<zzbkb> zzeew, zzeew<Executor> zzeew2, zzeew<JSONObject> zzeew3) {
        this.zzffc = zzeew;
        this.zzfev = zzeew2;
        this.zzffd = zzeew3;
    }

    public static zzbki zzc(zzeew<zzbkb> zzeew, zzeew<Executor> zzeew2, zzeew<JSONObject> zzeew3) {
        return new zzbki(zzeew, zzeew2, zzeew3);
    }
