...
public final class zzm {
    public static int zza(int i, int i2, String str) {
        ...
        if (i < 0) {
            str2 = zzn.zza("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i));
        } else if (i2 < 0) {
            ...
            str2 = zzn.zza("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i), Integer.valueOf(i2));
        }
