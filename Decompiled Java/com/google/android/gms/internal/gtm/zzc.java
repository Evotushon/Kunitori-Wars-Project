...
public final class zzc {
    ...
    public static final class zza extends zzrc<zza, C0026zza> implements zzsm {
        ...
        public static final class C0026zza extends zzrc.zza<zza, C0026zza> implements zzsm {
            private C0026zza() {
                super(zza.zznv);
            }

            /* synthetic */ C0026zza(zzd zzd) {
                this();
            }
        }
    ...
    public static final class C0027zzc extends zzrc<C0027zzc, zza> implements zzsm {
        private static volatile zzsu<C0027zzc> zznw;
        /* access modifiers changed from: private */
        public static final C0027zzc zzop = new C0027zzc();
        private int zznr;
        private String zzok = "";
        private long zzol;
        ...
        public static final class zza extends zzrc.zza<C0027zzc, zza> implements zzsm {
            private zza() {
                super(C0027zzc.zzop);
            }
        ...
        public final Object zza(int i, Object obj, Object obj2) {
            switch (zzd.zznq[i - 1]) {
                ...
                case 4:
                    return zzop;
                case 5:
                    zzsu<C0027zzc> zzsu = zznw;
                    if (zzsu == null) {
                        synchronized (C0027zzc.class) {
                            zzsu = zznw;
                            if (zzsu == null) {
        ...
        public static zzsu<C0027zzc> zza() {
            return (zzsu) zzop.zza(zzrc.zze.zzbax, (Object) null, (Object) null);
        }

        static {
            zzrc.zza(C0027zzc.class, zzop);
        }
    }
