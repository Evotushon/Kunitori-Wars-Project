...
public final class zzh extends zzuq<zzh> {
    ...
    public zzc.C0027zzc[] zzpg = new zzc.C0027zzc[0];
    ...
    public final void zza(zzuo zzuo) throws IOException {
        ...
        zzc.C0027zzc[] zzcArr = this.zzpg;
        if (zzcArr != null && zzcArr.length > 0) {
            while (true) {
                zzc.C0027zzc[] zzcArr2 = this.zzpg;
                if (i >= zzcArr2.length) {
                    break;
                }
                zzc.C0027zzc zzc = zzcArr2[i];
                if (zzc != null) {
                    zzuo.zze(3, (zzsk) zzc);
                }
                i++;
    ...
    public final /* synthetic */ zzuw zza(zzun zzun) throws IOException {
        while (true) {
            ...
            if (zzni == 10) {
                ...
                zzc.C0027zzc[] zzcArr2 = new zzc.C0027zzc[(zzb3 + length3)];
                if (length3 != 0) {
                    System.arraycopy(this.zzpg, 0, zzcArr2, 0, length3);
                }
                while (length3 < zzcArr2.length - 1) {
                    zzcArr2[length3] = (zzc.C0027zzc) zzun.zza(zzc.C0027zzc.zza());
                    zzun.zzni();
                    length3++;
                }
                zzcArr2[length3] = (zzc.C0027zzc) zzun.zza(zzc.C0027zzc.zza());
