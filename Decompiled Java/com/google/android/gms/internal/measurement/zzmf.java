...
public final class zzmf implements zzmg {
    ...
    static {
        ...
        zzb = zzdm.zza("measurement.config.cache_time", 86400000);
        zzc = zzdm.zza("measurement.log_tag", "FA");
        zzd = zzdm.zza("measurement.config.url_authority", "app-measurement.com");
        zze = zzdm.zza("measurement.config.url_scheme", Constants.SCHEME);
        ...
        zzk = zzdm.zza("measurement.alarm_manager.minimum_interval", 60000);
        zzl = zzdm.zza("measurement.upload.minimum_delay", 500);
        zzm = zzdm.zza("measurement.monitoring.sample_period_millis", 86400000);
        ...
        zzaj = zzdm.zza("measurement.upload.window_interval", 3600000);
    }
}
