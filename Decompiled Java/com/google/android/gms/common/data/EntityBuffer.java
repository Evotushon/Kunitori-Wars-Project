...
public abstract class EntityBuffer<T> extends AbstractDataBuffer<T> {
    private boolean zamj = false;
    private ArrayList<Integer> zamk;
    ...
    public final T get(int r7) {
        /*
            ...
            java.util.ArrayList<java.lang.Integer> r2 = r6.zamk
            int r2 = r2.size()
        ...
        L_0x0013:
            ...
            int r2 = r2.getCount()
            java.util.ArrayList<java.lang.Integer> r4 = r6.zamk
                    ...
                    while (i < count) {
                        ...
                        if (string2 != null) {
                            if (!string2.equals(string)) {
                                this.zamk.add(Integer.valueOf(i));
                                string = string2;
                            }
                            i++;
                        } else {
    ...
    private final int zah(int i) {
        if (i >= 0 && i < this.zamk.size()) {
            return this.zamk.get(i).intValue();
        }
