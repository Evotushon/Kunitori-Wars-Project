...
public class FastParser<T extends FastJsonResponse> {
    private static final char[] zaqw = {'u', 'l', 'l'};
    private static final char[] zaqx = {'r', 'u', 'e'};
    private static final char[] zaqy = {'r', 'u', 'e', '\"'};
    private static final char[] zaqz = {'a', 'l', 's', 'e'};
    private static final char[] zara = {'a', 'l', 's', 'e', '\"'};
    private static final char[] zarb = {10};
    private static final zaa<Integer> zard = new zaa();
    private static final zaa<Long> zare = new zac();
    private static final zaa<Float> zarf = new zab();
    private static final zaa<Double> zarg = new zae();
    private static final zaa<Boolean> zarh = new zad();
    private static final zaa<String> zari = new zag();
    private static final zaa<BigInteger> zarj = new zaf();
    private static final zaa<BigDecimal> zark = new zah();
    private final char[] zaqr = new char[1];
    private final char[] zaqs = new char[32];
    private final char[] zaqt = new char[1024];
    private final StringBuilder zaqu = new StringBuilder(32);
    private final StringBuilder zaqv = new StringBuilder(1024);
    private final Stack<Integer> zarc = new Stack<>();
            ...
            if (zaj != 0) {
                if (zaj == '[') {
                    ...
                    if (fieldMappings.size() == 1) {
                        ...
                        t.addConcreteTypeArrayInternal(field, field.zaql, zaa(bufferedReader, (FastJsonResponse.Field<?, ?>) field));
                    } else {
    ...
    private final boolean zaa(java.io.BufferedReader r17, com.google.android.gms.common.server.response.FastJsonResponse r18) throws com.google.android.gms.common.server.response.FastParser.ParseException, java.io.IOException {
        ...
        L_0x001d:
            ...
            goto L_0x001d
        L_0x002c:
            java.util.Stack<java.lang.Integer> r10 = r1.zarc
            r11 = 4
        ...
        L_0x005e:
            ...
            java.lang.String r10 = r5.zaql
            r2.addConcreteTypeArrayInternal(r5, r10, r9)
            goto L_0x026f
        L_0x0074:
            java.util.Stack<java.lang.Integer> r12 = r1.zarc
            r15 = 5
        ...
        L_0x0095:
            ...
            goto L_0x026f
        L_0x00a7:
            java.util.Stack<java.lang.Integer> r15 = r1.zarc
            r15.push(r8)
            ...
            java.lang.String r12 = r5.zaql     // Catch:{ InstantiationException -> 0x00c3, IllegalAccessException -> 0x00bc }
        ...
        L_0x00fe:
            char[] r12 = r1.zaqs
            java.lang.StringBuilder r11 = r1.zaqu
        ...
        L_0x014e:
            char[] r6 = r1.zaqs
            java.lang.StringBuilder r12 = r1.zaqu
        ...
        L_0x0195:
            char[] r6 = r1.zaqt
            java.lang.StringBuilder r10 = r1.zaqv
            char[] r11 = zarb
        ...
        L_0x01bc:
            ...
            com.google.android.gms.common.server.response.FastParser$zaa<java.lang.String> r6 = zari
        ...
        L_0x01d2:
            ...
            com.google.android.gms.common.server.response.FastParser$zaa<java.lang.Boolean> r6 = zarh
            java.util.ArrayList r6 = r1.zaa((java.io.BufferedReader) r0, r6)
            r2.zag(r5, r6)
            goto L_0x01b8
        L_0x01e0:
        ...
        L_0x01ea:
            ...
            com.google.android.gms.common.server.response.FastParser$zaa<java.math.BigDecimal> r10 = zark
        ...
        L_0x0202:
            ...
            com.google.android.gms.common.server.response.FastParser$zaa<java.lang.Double> r10 = zarg
            java.util.ArrayList r10 = r1.zaa((java.io.BufferedReader) r0, r10)
            r2.zae(r5, r10)
            goto L_0x026f
        L_0x0210:
        ...
        L_0x0218:
            ...
            com.google.android.gms.common.server.response.FastParser$zaa<java.lang.Float> r10 = zarf
            java.util.ArrayList r10 = r1.zaa((java.io.BufferedReader) r0, r10)
            r2.zad(r5, r10)
            goto L_0x026f
        L_0x0226:
        ...
        L_0x022e:
            ...
            com.google.android.gms.common.server.response.FastParser$zaa<java.lang.Long> r10 = zare
            java.util.ArrayList r10 = r1.zaa((java.io.BufferedReader) r0, r10)
            r2.zac(r5, r10)
            goto L_0x026f
        L_0x023c:
        ...
        L_0x0244:
            ...
            com.google.android.gms.common.server.response.FastParser$zaa<java.math.BigInteger> r10 = zarj
            java.util.ArrayList r10 = r1.zaa((java.io.BufferedReader) r0, r10)
        ...
        L_0x025a:
            ...
            com.google.android.gms.common.server.response.FastParser$zaa<java.lang.Integer> r10 = zard
            java.util.ArrayList r10 = r1.zaa((java.io.BufferedReader) r0, r10)
    ...
    private final String zaa(BufferedReader bufferedReader) throws ParseException, IOException {
        ...
        if (zaj == '\"') {
            this.zarc.push(3);
            String zab = zab(bufferedReader, this.zaqs, this.zaqu, (char[]) null);
            zak(3);
    ...
    private final String zab(BufferedReader bufferedReader) throws ParseException, IOException {
        ...
        } else if (bufferedReader2.read(this.zaqr) != -1) {
            char c = this.zaqr[0];
            boolean z3 = false;
            do {
                if (c != '\"' || z3) {
                    z3 = c == '\\' ? !z3 : false;
                    if (bufferedReader2.read(this.zaqr) != -1) {
                        c = this.zaqr[0];
                    } else {
    ...
    public final int zad(BufferedReader bufferedReader) throws ParseException, IOException {
        ...
        int i3;
        int i4;
        int zaa2 = zaa(bufferedReader, this.zaqt);
        if (zaa2 == 0) {
            return 0;
        }
        char[] cArr = this.zaqt;
    ...
    public final BigInteger zaf(BufferedReader bufferedReader) throws ParseException, IOException {
        ...
        return new BigInteger(new String(this.zaqt, 0, zaa2));
    }
    ...
    public final boolean zaa(BufferedReader bufferedReader, boolean z) throws ParseException, IOException {
        while (true) {
            ...
            if (zaj != '\"') {
                if (zaj == 'f') {
                    zab(bufferedReader, z ? zara : zaqz);
                    return false;
                } else if (zaj == 'n') {
                    zab(bufferedReader, zaqw);
                    return false;
    ...
    public final float zag(BufferedReader bufferedReader) throws ParseException, IOException {
        ...
        return Float.parseFloat(new String(this.zaqt, 0, zaa2));
    }
    ...
    public final double zah(BufferedReader bufferedReader) throws ParseException, IOException {
        ...
        return Double.parseDouble(new String(this.zaqt, 0, zaa2));
    }
    ...
    public final BigDecimal zai(BufferedReader bufferedReader) throws ParseException, IOException {
        ...
        return new BigDecimal(new String(this.zaqt, 0, zaa2));
    }
    ...
    private final char zaj(BufferedReader bufferedReader) throws ParseException, IOException {
        if (bufferedReader.read(this.zaqr) == -1) {
            return 0;
        }
        while (Character.isWhitespace(this.zaqr[0])) {
            if (bufferedReader.read(this.zaqr) == -1) {
                return 0;
            }
        }
    ...
    private final void zab(BufferedReader bufferedReader, char[] cArr) throws ParseException, IOException {
        int i = 0;
        while (i < cArr.length) {
            int read = bufferedReader.read(this.zaqs, 0, cArr.length - i);
            if (read != -1) {
                int i2 = 0;
                while (i2 < read) {
                    if (cArr[i2 + i] == this.zaqs[i2]) {
                        i2++;
                    } else {
    ...
    private final void zak(int i) throws ParseException {
        if (!this.zarc.isEmpty()) {
            int intValue = this.zarc.pop().intValue();
            if (intValue != i) {
