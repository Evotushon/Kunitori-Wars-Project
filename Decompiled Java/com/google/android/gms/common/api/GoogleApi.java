...
public class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public static class Settings {
        ...
        public static class Builder {
            ...
            public Settings build() {
                ...
                return new Settings(this.zabo, this.zabm);
            }
        }
    ...
    private final <TResult, A extends Api.AnyClient> Task<TResult> zaa(int i, @NonNull TaskApiCall<A, TResult> taskApiCall) {
        ...
        this.zabp.zaa(this, i, taskApiCall, taskCompletionSource, this.zabo);
    ...
    public <A extends Api.AnyClient> Task<Void> doRegisterEventListener(@NonNull RegistrationMethods<A, ?> registrationMethods) {
        ...
        Preconditions.checkNotNull(registrationMethods.zakc.getListenerKey(), "Listener has already been released.");
    ...
    public <L> ListenerHolder<L> registerListener(@NonNull L l, String str) {
        return ListenerHolders.createListenerHolder(l, this.zabm, str);
    }

    /* access modifiers changed from: protected */
    @KeepForSdk
    public Task<Boolean> disconnectService() {
        return this.zabp.zac((GoogleApi<?>) this);
    }

    @WorkerThread
    public Api.Client zaa(Looper looper, GoogleApiManager.zaa<O> zaa) {
        return this.mApi.zai().buildClient(this.mContext, looper, createClientSettingsBuilder().build(), this.zabk, (GoogleApiClient.ConnectionCallbacks) zaa, (GoogleApiClient.OnConnectionFailedListener) zaa);
    }
