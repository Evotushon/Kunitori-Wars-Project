...
public final class AppOpenAdView extends ViewGroup {
    ...
    public final void setAppOpenAd(AppOpenAd appOpenAd) {
        IObjectWrapper zzkc;
        try {
            zzvx zzdr = appOpenAd.zzdr();
            if (zzdr != null && (zzkc = zzdr.zzkc()) != null) {
    ...
    private final void zzds() {
        ...
        AppOpenAd appOpenAd = this.zzacg;
        if (appOpenAd != null && (appOpenAdPresentationCallback = this.zzach) != null) {
            appOpenAd.zza(new zzrd(appOpenAdPresentationCallback));
        }
    }

    private final AdSize getAdSize() {
        zzvx zzdr = this.zzacg.zzdr();
        if (zzdr == null) {
            return null;
        }
        try {
