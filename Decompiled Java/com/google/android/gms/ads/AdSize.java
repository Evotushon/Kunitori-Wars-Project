...
public final class AdSize {
    ...
    public static final AdSize zzabj = new AdSize(50, 50, "50x50_mb");
    ...
    public final boolean equals(Object obj) {
        ...
        return this.width == adSize.width && this.height == adSize.height && this.zzabk.equals(adSize.zzabk);
    }
    ...
    public final int getHeightInPixels(Context context) {
        ...
        if (i == -2) {
            return zzuk.zzc(context.getResources().getDisplayMetrics());
        }
        zzvh.zzoz();
        return zzayx.zzb(context, this.height);
    }
    ...
    public final int getWidthInPixels(Context context) {
        ...
        if (i == -1) {
            return zzuk.zzb(context.getResources().getDisplayMetrics());
        }
        zzvh.zzoz();
        return zzayx.zzb(context, this.width);
    }
