...
public final class zzij extends zzg {
    ...
    /* access modifiers changed from: private */
    @WorkerThread
    public final void zza(Bundle bundle, @NonNull zzig zzig, zzig zzig2, long j) {
        if (bundle != null) {
    ...
    public final void zza(Activity activity, Bundle bundle) {
        ...
        if (zzs().zzh().booleanValue() && bundle != null && (bundle2 = bundle.getBundle("com.google.app_measurement.screen_service")) != null) {
            this.zzd.put(activity, new zzig(bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.NAME), bundle2.getString("referrer_name"), bundle2.getLong("id")));
        }
    }
    ...
    public final void zzb(Activity activity, Bundle bundle) {
        ...
        if (zzs().zzh().booleanValue() && bundle != null && (zzig = this.zzd.get(activity)) != null) {
            ...
            bundle2.putString(AppMeasurementSdk.ConditionalUserProperty.NAME, zzig.zza);
