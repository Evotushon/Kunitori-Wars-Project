...
final class zzq {
    ...
    public final zzcd.zza zza(int i) {
        ArrayList arrayList;
        List list;
        zzcd.zza.C0030zza zzh2 = zzcd.zza.zzh();
        zzh2.zza(i);
        zzh2.zza(this.zzb);
        ...
        if (map == null) {
            ...
            for (Integer intValue : this.zzf.keySet()) {
                ...
                arrayList2.add((zzcd.zzb) ((zzhz) zzcd.zzb.zze().zza(intValue2).zza(this.zzf.get(Integer.valueOf(intValue2)).longValue()).zzz()));
            }
        ...
        if (map2 == null) {
            ...
            for (Integer next : this.zzg.keySet()) {
                ...
                arrayList3.add((zzcd.zzj) ((zzhz) zza3.zzz()));
            }
            list = arrayList3;
        }
        zza2.zzd(list);
