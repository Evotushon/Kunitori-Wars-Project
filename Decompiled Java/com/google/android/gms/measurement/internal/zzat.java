...
public final class zzat {
    ...
    public static zzeg<Integer> zzag;
    public static zzeg<Integer> zzah = zza("measurement.upload.max_public_event_params", 25, 25, (zzee) null);
    public static zzeg<Long> zzai = zza("measurement.service_client.idle_disconnect_millis", 5000L, 5000L, zzbt.zza);
    ...
    public static zzeg<Long> zzb = zza("measurement.monitoring.sample_period_millis", 86400000L, 86400000L, zzav.zza);
    ...
    public static zzeg<Long> zzc = zza("measurement.config.cache_time", 86400000L, 3600000L, zzbe.zza);
    ...
    public static zzeg<String> zzd = zza("measurement.config.url_scheme", Constants.SCHEME, Constants.SCHEME, zzbr.zza);
    ...
    public static zzeg<Long> zzr = zza("measurement.upload.window_interval", 3600000L, 3600000L, zzbd.zza);
    public static zzeg<Long> zzs = zza("measurement.upload.interval", 3600000L, 3600000L, zzbc.zza);
    ...
    public static zzeg<Long> zzw = zza("measurement.alarm_manager.minimum_interval", 60000L, 60000L, zzbj.zza);
    public static zzeg<Long> zzx = zza("measurement.upload.stale_data_deletion_interval", 86400000L, 86400000L, zzbi.zza);
    ...
    @VisibleForTesting
    private static <V> zzeg<V> zza(@Nullable String str, @Nullable V v, @Nullable V v2, @Nullable zzee<V> zzee) {
    ...
    static {
        ...
        zzag = zza("measurement.upload.max_event_name_cardinality", valueOf, valueOf, (zzee) null);
        Double valueOf2 = Double.valueOf(-3.0d);
        zzan = zza("measurement.test.double_flag", valueOf2, valueOf2, zzbw.zza);
    }
}
