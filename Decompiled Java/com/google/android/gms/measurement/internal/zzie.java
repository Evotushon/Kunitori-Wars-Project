...
final class zzie extends zzkj {
    ...
    @WorkerThread
    public final byte[] zza(@NonNull zzar zzar, @Size(min = 1) String str) {
        zzkt zzkt;
        Bundle bundle;
        zzcd.zzf.zza zza;
        zzcd.zzg.zza zza2;
            ...
            if (zzb2 == null) {
                ...
                try {
                    ...
                    if (zzkt == null || zzkt.zze == null) {
                        zzkt zzkt2 = new zzkt(zzc2, "auto", "_lte", zzl().currentTimeMillis(), 0L);
                        zza6.add(zzkt2);
                        zzi().zza(zzkt2);
                    }
                    zzks f_ = f_();
                    ...
                    if (f_.zzk().zzi()) {
                        ...
                        if (zzb2.zzaf() && f_.zzj().zze(zzc3)) {
                            ...
                            zza6.add(new zzkt(zzc3, "auto", "_npa", f_.zzl().currentTimeMillis(), 1L));
                        }
                    }
