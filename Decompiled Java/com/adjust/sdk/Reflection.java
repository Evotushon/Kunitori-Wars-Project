...
public class Reflection {
    ...
    public static String getPlayAdId(Context context) {
        try {
            return (String) invokeInstanceMethod(getAdvertisingInfoObject(context), "getId", (Class[]) null, new Object[0]);
    ...
    public static Boolean isPlayTrackingEnabled(Context context) {
        try {
            boolean z = false;
            Boolean bool = (Boolean) invokeInstanceMethod(getAdvertisingInfoObject(context), "isLimitAdTrackingEnabled", (Class[]) null, new Object[0]);
            if (bool == null) {
                return null;
            }
