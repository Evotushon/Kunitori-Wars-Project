...
public class SharedPreferencesManager {
    ...
    public synchronized org.json.JSONArray getRawReferrerArray() {
        /*
            ...
            org.json.JSONArray r1 = new org.json.JSONArray     // Catch:{ Throwable | JSONException -> 0x0034 }
            r1.<init>(r0)     // Catch:{ Throwable | JSONException -> 0x0034 }
            int r2 = r1.length()     // Catch:{ Throwable | JSONException -> 0x0034 }
            r3 = 10
            if (r2 <= r3) goto L_0x002d
            org.json.JSONArray r0 = new org.json.JSONArray     // Catch:{ Throwable | JSONException -> 0x0034 }
            r0.<init>()     // Catch:{ Throwable | JSONException -> 0x0034 }
            r2 = 0
        L_0x001c:
            if (r2 >= r3) goto L_0x0028
            java.lang.Object r4 = r1.get(r2)     // Catch:{ Throwable | JSONException -> 0x0034 }
            r0.put(r4)     // Catch:{ Throwable | JSONException -> 0x0034 }
            int r2 = r2 + 1
            goto L_0x001c
        L_0x0028:
            r5.saveRawReferrerArray(r0)     // Catch:{ Throwable | JSONException -> 0x0034 }
            monitor-exit(r5)
            return r0
        L_0x002d:
            org.json.JSONArray r1 = new org.json.JSONArray     // Catch:{ Throwable | JSONException -> 0x0034 }
